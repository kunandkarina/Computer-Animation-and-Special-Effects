...
void mainPanel(std::shared_ptr<kinematics::Ball> ball) {
    ...
    if (ImGui::Begin("Control")) {
        ...
        //add a button of isRunning at the same line of FK, if !isFKPanel than hide the button
        if (!isFKPanel) {
            ImGui::SameLine();
            ...
            ImGui::SameLine();
            ImGui::Text(isRunning ? "Running" : "Not Running");
        }
        // ImGui::SameLine();
        // if (ImGui::Button("Running")) {
        //     isRunning ^= true;
        // }
        //add a text message to show the status of isRunning
        ImGui::SameLine();
        ImGui::Text(isRunning ? "Running" : "Not Running");
